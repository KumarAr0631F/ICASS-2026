...
const Contact = () => {
  ...
  return (
    <div className="flex justify-center text-2xl items-center min-h-screen bg-gray-100">
      <div className="bg-white shadow-lg rounded-lg p-6">
        ...
        <table className="table-auto border-collapse border border-gray-300 w-full">
          <tbody>
            ...
            <tr>
              <td className="border border-gray-900 px-4 py-2">For Paper Submission Enquiries</td>
              <td className="border border-gray-900 px-4 py-2">icass2026@mru.edu.in</td>
            </tr>
          </tbody>
        </table>
