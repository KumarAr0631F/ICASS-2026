      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-32">
        <div>
          ...
          <ul className="list-disc ml-6 mb-3 text-justify text-gray-700">
            ...
            <li>Dr Ilyos Rabbimov, Researcher, Center for Economic Research and Reform under the Administration of the President of the Republic of Uzbekistan, Tashkent, Uzbekistan</li>
