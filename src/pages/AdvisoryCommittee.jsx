    ...
    <div>
      ...
      <div className="container mx-auto px-6 md:px-12">
        ...
        <div className="mb-3">
          ...
          {/* Chief Patrons */}
          <h2 className="text-xl font-semibold text-gray-700">International Advisory Committee</h2>
          <ul className="list-disc ml-6 mb-3 text-justify text-gray-700">
            ...
            <li>Prof (Dr) Uma Jha, Senior IEEE Fellow and Professor of Practice, ECE, University of Florida, Gainesville, FloridaUSA</li>
            ...
            <li>Dr Muluneh Lemma Woldesemayat	Associate Professor and Scientific Director of Arba Minch Institute of Technology (AMiT)
Bsc Arba Minch University, Ethiopia
</li>
            ...
            <li>Dr Arindam Pal	Director, Data Science and Optimization, Optym Bangaluru,
Conjoint Senior Lecturer, University of New South Wales, Sydney, Australia
</li>
            <li>Dr. Parnika Gupta	Senior Engineer, Global Foundaries, Belgium</li>
            ...
            <li>Mr. Prashant Gupta	Software Development Manager, Amazon, USA</li>
          </ul>
