              ...
              <tr className="border-b border-gray-200 hover:bg-blue-50 transition-colors duration-200">
                ...
                <td className="px-1 py-2 text-center border-l border-gray-200">
                  <div className="space-y-1">
                    ...
                    <span className="block text-gray-500 text-xs sm:text-sm">7,200</span>
                  </div>
                </td>
                <td className="px-1 py-2 text-center border-l border-gray-200">
                  <div className="space-y-1">
                    ...
                    <span className="block text-gray-500 text-xs sm:text-sm">225</span>
                  </div>
                </td>
              </tr>
              ...
              <tr className="border-b border-gray-200 bg-gray-50 hover:bg-blue-50 transition-colors duration-200">
                ...
                <td className="px-1 py-2 text-center border-l border-gray-200">
                  <div className="space-y-1">
                    ...
                    <span className="block text-gray-500 text-xs sm:text-sm">6,300</span>
                  </div>
                </td>
                <td className="px-1 py-2 text-center border-l border-gray-200">
                  <div className="space-y-1">
                    ...
                    <span className="block text-gray-500 text-xs sm:text-sm">135</span>
                  </div>
                </td>
              </tr>
              ...
              <tr className="border-b border-gray-200 hover:bg-blue-50 transition-colors duration-200">
                ...
                <td className="px-1 py-2 text-center border-l border-gray-200">
                  <div className="space-y-1">
                    ...
                    <span className="block text-gray-500 text-xs sm:text-sm">8,100</span>
                  </div>
                </td>
                <td className="px-1 py-2 text-center border-l border-gray-200">
                  <div className="space-y-1">
